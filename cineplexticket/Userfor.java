...
public class Userfor extends javax.swing.JFrame {
Connection conn ;
ResultSet rs ;
PreparedStatement pst;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
             String sql ;
    sql = "UPDATE usercreate SET userpassword = ?WHERE username =?";
        try
        {
            while(rs.next())
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Userfor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
